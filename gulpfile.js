...
function buildCSS() {
  ...
  return gulp
    .src("./styles/*") //tell gulp to get EVERYTHING inside the styles folder.
...
function buildViews() {
  ...
  return gulp.src("views/**/*.html").pipe(gulp.dest("./dist/views"));
}
...
function buildDL() {
  ...
  return gulp.src("download/**/*").pipe(gulp.dest("./dist/download"));
}
